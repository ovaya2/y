...
| 5. Whitespace-Normalisierung — nice-to-have | 🟢 | ✓ als optionale Phase 6 | §5 (Phase 6), §7.1, §8 #10 |
| Offene Frage: d_objekttyp-Inhalte | — | ✓ aufgenommen | §8 #7 |
| Offene Frage: Vereinssitz-Variante | — | ✓ aufgenommen + Default-Vorschlag | §8 #8 |
| Offene Frage: Beschreibung Freitext vs. strukturiert | — | ✓ aufgenommen | §8 #9 |
| Offene Frage: Whitespace als Phase 6 | — | ✓ aufgenommen | §8 #10 |
