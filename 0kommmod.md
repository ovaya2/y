...
%%{init: {'themeVariables': { 'edgeLabelBackground':'#e3f2fd'}}}%%

graph TD
    %% Styling Klassen für bessere visuelle Trennung
    classDef azubi fill:#004000,stroke:#4caf50,stroke-width:2px;
    classDef ki_zyklus fill:#006000,stroke:#2196f3,stroke-width:2px;
    %% classDef doku fill:#006000,stroke:#ff9800,stroke-width:2px;
    classDef fokus fill:#995050,stroke:#9e9e9e,stroke-dasharray: 5 5;
    classDef ki_interaktion fill:#995050,stroke:#9e9e9e,stroke-dasharray: 5 5;
